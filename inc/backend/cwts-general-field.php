    ...
    <div class="cwts-setting-tab-content" id="content-cwts-setting-general">
        <div class="cwts-default-setting-field-wrapper" id='cwts-basic-layout-setting'>
            <div class="cwts-setting-tab-content-inner" id="content-cwts-setting-general-input-type">
                ...
                $general_info_maxkey = !empty($cwts_meta_array) ? array_keys($cwts_meta_array, max($cwts_meta_array)) : array('0' => '3');
                ?>
            </div>
            
        </div>
        <input type="hidden" name="cwts_meta_fields[cwts_gen_infcount]" value="<?php echo esc_attr($general_info_maxkey[0]); ?>" class="cwts-general-info-count"/>
    </div>
</div>
