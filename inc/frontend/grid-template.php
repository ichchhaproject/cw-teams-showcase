                                              ...
                                              <div class="team-member text-center">
                                                ...
                                                <div class="overlay">
                                                    <div class="team-details text-center">
                                                      <p>
                                                         <?php echo $cwts_meta_settings['cw_team_member_description'];?>
                                                     </p>
                                                     <div class="socials mt-20">
                                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_fb_link'];?>"><i class="fa fa-facebook"></i></a>
                                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_twitter_link'];?>"><i class="fa fa-twitter"></i></a>
                                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_google_link'];?>"><i class="fa fa-google-plus"></i></a>
                                                        <a href="mailto:<?php echo $cwts_meta_settings['cw_team_member_email'];?>"><i class="fa fa-envelope"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <h6 class="team-title"><?php echo $cwts_meta_settings['cw_team_member_name'];?></h6>
                                        <span><?php echo $cwts_meta_settings['cw_team_member_designation'];?></span>
                                    </div>
                                </div>
