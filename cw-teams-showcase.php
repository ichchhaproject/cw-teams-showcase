...
if (!defined('CWTS_TEXT_DOMAIN')) {
    define('CWTS_TEXT_DOMAIN', 'cw-team-showcase');
}
...
if (!class_exists('CWTS_Class')) {
    class CWTS_Class {
    	function __construct() {
            ...
            add_shortcode('cwteamsshowcase', array($this, 'cwteamsshowcase_shortcode'));
        ...
        function plugin_text_domain() {
            load_plugin_textdomain('cw-team-showcase', false, basename(dirname(__FILE__)) . '/languages/');
        }
        ...
        function cwteamsshowcase_shortcode($attr) {
            ob_start();
