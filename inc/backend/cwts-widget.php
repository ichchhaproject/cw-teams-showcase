...
class CWTS_Widget extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <div class="cwts-widget-wrap">
            ...
            <div id="cwts-thumbnail-layout-basic-template" <?php if (isset($instance['layout_type']) && $instance['layout_type'] == 'thumbnail-layout') { ?> style="display:block;"<?php } else { ?>style="display:none;"<?php } ?>>
                
               </div> 
            
            <div class="cwts-widget-input-field-wrap cwts-shortcode-id-checkbox-outer-wrap" id="cwts-widget-content-by-member-id" <?php if (isset($instance['element_to_show']) && $instance['element_to_show'] == 'member-id') { ?> style="display:block;"<?php } else { ?>style="display:none;"<?php } ?>>
                <label>
                    <?php echo __('Custom Member ID', CWTS_TEXT_DOMAIN); ?>
                </label>
                <div class="cwts-input-field cwts-shortcode-id-checkbox-wrap" id="cwts-member-by-id-checkbox-wrap" >
                    <?php
                    $args = array(
                    ...
                    if ($the_query->have_posts()) : while ($the_query->have_posts()) : $the_query->the_post();
                            ?>
                            <div>        
                                <label class="cwts-widget-input-field">
                                    <input class="cwts-add-check cwts-shortcode-member-id-check" type="checkbox" id="<?php echo $this->get_field_id('cwts_add_member_check'); ?>" name="<?php echo $this->get_field_name('cwts_add_member_check'); ?>[]" data-author-name="<?php echo get_the_title(); ?>" value="<?php the_id(); ?>" <?php
                                    ...
                                    ?>/>
                                           ...
                                           echo!empty($post_title) ? esc_attr($post_title) : 'Untitled';
                                           ?>
                                </label>
                            </div>
                            <?php
