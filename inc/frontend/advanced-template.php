                            ...
                            <div class="cwts-inner-whole-wrapper">
                                <div class="user-wrap">
                                    <article class="material-card Red">
                                        <h2>
                                            <span><?php echo $cwts_meta_settings['cw_team_member_name'];?></span>
                                            <strong>
                                                <i class="fa fa-fw fa-star"></i>
                                                <?php echo $cwts_meta_settings['cw_team_member_designation'];?>
                                            </strong>
                                        </h2>
                                    ...
                                    <div class="mc-footer">
                                        ...
                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_fb_link'];?>" class="fa fa-fw fa-facebook"></a>
                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_twitter_link'];?>" class="fa fa-fw fa-twitter"></a>
                                        <a href="<?php echo $cwts_meta_settings['cw_team_member_google_link'];?>"class="fa fa-fw fa-google-plus"></a>
                                    </div>
                                </article>
                            </div>
